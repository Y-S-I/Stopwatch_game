...
HD_PWD='C:/Reality/Verilog Workspace/Stopwatch_game/Stopwatch_game.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_game.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stopwatch_game.tcl -notrace
