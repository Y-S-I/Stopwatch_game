...
HD_PWD='C:/Reality/Verilog Workspace/Stopwatch_game/Stopwatch_game.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_game.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_game.tcl
